...
export default function JobsListingPage() {
  ...
  const filteredJobs = jobs.filter((job) => {
    ...
    const matchesTags =
      ...
      job.tags.some((tag) => selectedTags.includes(tag.toLowerCase()));
  ...
  const jobTypes = [
    ...
    "Seasonal",
    "Fixed Price",
  ]; // Changed 'Full-time' to 'Full Time' to match job data
    ...
    <>
      ...
      <div className="educators-wrapper jobs-wrapper">
        ...
        <div className="jobs-listing-wrapper pb-0">
                    ...
                    <div key={job.id} className="job-card">
                      <div className="job-card-content">
                        <div className="d-flex align-items-center justify-content-between mb-3">
                          <p className="job-posted-time mb-0">
                            {job.posted} ago
                          </p>
          ...
          <div
            className="tailored-talent-section jobs-talent-section text-white mt-5"
            style={{ padding: "70px 0px 80px" }}
          >
            <div className="container ">
                      ...
                      <div className="row gy-4 mb-4">
                        ...
                        <div className="col-md-12">
                          <div className="form-check">
                            ...
                            >
                              Subscribe to receive similar engineering and
                              design jobs directly to your email and stay ahead
                              in your career.{" "}
                            </label>
                          </div>
                        </div>
